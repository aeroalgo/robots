...
impl SimpleIndicators {
    pub async fn new(data: Vec<f64>) -> Self {
    ...
    async fn calculate_super_trend(&self, period: f64, coeff_atr: f64) -> Vec<f64> {
    ...
    pub async fn get_sma(&mut self, period: f64, meta: bool) -> IndicatorData {
        self.meta.current_param = HashMap::from([("period".to_string(), period)]);
    ...
    async fn calculate_sma(&mut self, period: f64) {
        let data = &self.data;
        let count = self.data.len();
        ...
        for i in 0..num {
            num2 += data.index(i);
            let value = num2 / (i as f64 + 1 as f64);
            result.push(value);
        }
        for i in num..count {
            let num3: &f64 = data.index(i);
            let num4: &f64 = data.index(i - period as usize);
            let num5: &f64 = result.index(i - 1);
            result.push(num5 + (num3 - num4) / period as f64)
        }
        self.result = result;
    }
    ...
    async fn calculate_maxfor(&mut self, period: f64) {
        let data = &self.data;
        let count = data.len();
        let num = min(count, period as usize);
    ...
    async fn calculate_minfor(&mut self, period: f64) {
        let data = &self.data;
        let count = data.len();
        let num = min(count, period as usize);
        let mut result: Vec<f64> = Vec::new();
    ...
    pub async fn get_geomean(&mut self, period: f64, meta: bool) -> IndicatorData {
        self.meta.current_param = HashMap::from([("period".to_string(), period)]);
        self.meta.name = String::from("GEOMEAN");
        self.meta.name_param = vec!["period".to_string()];
        self.meta.value_param = vec![period];
    ...
    async fn calculate_geomean(&mut self, period: f64) {
        let data = &self.data;
        let count = data.len();
        let mut result: Vec<f64> = Vec::new();
        for i in 0..count {
    ...
    pub async fn get_amma(&mut self, period: f64, meta: bool) -> IndicatorData {
        self.meta.current_param = HashMap::from([("period".to_string(), period)]);
    ...
    async fn calculate_amma(&mut self, period: f64) {
        let data = &self.data;
        let count = data.len();
        let mut result: Vec<f64> = Vec::new();
        for i in 0..count {
    ...
    pub async fn get_sqwma(&mut self, period: f64, meta: bool) -> IndicatorData {
        self.meta.current_param = HashMap::from([("period".to_string(), period)]);
    ...
    async fn calculate_sqwma(&mut self, period: f64) {
        let data = &self.data;
        let count = data.len();
        let mut result: Vec<f64> = Vec::new();
    ...
    pub async fn get_sinewma(&mut self, period: f64, meta: bool) -> IndicatorData {
        self.meta.current_param = HashMap::from([("period".to_string(), period)]);
    ...
    async fn calculate_sinewma(&mut self, period: f64) {
        let data = &self.data;
        let count = data.len();
        let mut result: Vec<f64> = Vec::new();
        for i in 0..count {
            if i < period as usize {
                ...
                for j in 0..period as usize - 1 {
                    num3 += (num * (j as f64 + 1.0) / (period + 1.0)).sin();
                    num2 += data[i - j as usize] * (num * (j as f64 + 1.0) / (period + 1.0)).sin();
                }
                let mut result2 = 0.0;
                if num3 > 0.0 {
                    result2 = num2 / num3;
                }
                result.push(result2 as f64);
            }
        }
        self.result = result;
    }

    pub async fn get_ama(&mut self, period: f64, meta: bool) -> IndicatorData {
        self.meta.current_param = HashMap::from([("period".to_string(), period)]);
    ...
    async fn calculate_ama(&mut self, period: f64) {
        let data = &self.data;
        let count = data.len();
        let mut result: Vec<f64> = Vec::new();
        ...
        for i in 0..count {
            if i < (period + 2.0) as usize {
                ...
                let num6 = num + num5 * (data[i] - num as f64) as f64;
                result.push(num6 as f64);
                num = num6;
            }
        }
        self.result = result;
    }
    pub async fn get_zlema(&mut self, period: f64, meta: bool) -> IndicatorData {
        self.meta.current_param = HashMap::from([("period".to_string(), period)]);
    ...
    async fn calculate_zlema(&self, data: &Vec<f64>, period: f64) -> Vec<f64> {
        let count = data.len();
        let mut result: Vec<f64> = Vec::new();
        let num: f64 = 2.0 / (period + 1.0);
    ...
    pub async fn get_ema(&mut self, period: f64, meta: bool) -> IndicatorData {
        self.meta.current_param = HashMap::from([("period".to_string(), period)]);
    ...
    async fn calculate_ema(&mut self, period: f64) {
        let data = &self.data;
        let count = data.len();
        let mut result: Vec<f64> = Vec::new();
        // let mut num: f64 = 2.0 / (period as f64 + 1.0);
        let num: f64 = 2.0 / (period + 1.0);
        for i in 0..count {
            if i < period as usize {
                result.push(data[i]);
    ...
    pub async fn get_tpbf(&mut self, period: f64, meta: bool) -> IndicatorData {
    ...
    async fn calculate_tpbf(&mut self, h: &Vec<f64>, l: &Vec<f64>, period: f64) {
        let count = h.len();
        let mut result: Vec<f64> = Vec::new();
        let num = 1.0_f64.atan() as f64;
        let num2 = 45.0 / num;
        let num3 = 1.0 / num2;
        let num4 = 1.0_f64.atan() * 4.0_f64;
        let num5 = (-num4 as f64 / period as f64).exp();
        let num6 = 2.0 * num5 * (num3 * (3.0_f64.sqrt() as f64) * 180.0 / period as f64).cos();
        let num7 = num5 * num5;
        let num8 = num6 + num7;
                ...
                result.push(
                    (num11
                        * ((*&l[i] + *&h[i]) / 2.0
                        ...
                        + num10 * result[i - 3] as f64) as f64,
                )
            }
        }
        self.result = result;
    }
    pub async fn get_wma(&mut self, period: f64, meta: bool) -> IndicatorData {
        self.meta.current_param = HashMap::from([("period".to_string(), period)]);
    ...
    async fn calculate_wma(&mut self, period: f64) {
        let data = &self.data;
        let count = data.len();
        let mut result: Vec<f64> = vec![0.0; count];
        let mut num: f64 = 0.0;
        let mut num2: f64 = 0.0;
        for i in 0..period as usize {
            num2 = num2 + i as f64 + 1.0
        }
    ...
    pub async fn get_rsi(&mut self, period: f64, meta: bool) -> IndicatorData {
        self.meta.current_param = HashMap::from([("period".to_string(), period)]);
    ...
    async fn calculate_rsi(&mut self, period: f64) {
        let data = &self.data;
        let count = data.len();
        let mut result: Vec<f64> = vec![0.0; count];
        if count > 0 {
    ...
    //     return result;
    // }
    // async fn calculate_ma_to_hl(&self, hhi: Vec<f64>, lli: Vec<f64>) -> Vec<f64> {
    //     let count = hhi.len();
    //     let mut result: Vec<f64> = Vec::new();
    //     let mut num = 0.0;
    //     for i in 1..count {
