...
impl MemoryAnalyzer {
    ...
    pub fn compare_memory_usage() -> HashMap<String, f32> {
        ...
        comparison.insert("basic_size_bytes".to_string(), *basic_size as f32);
        comparison.insert("optimized_size_bytes".to_string(), *optimized_size as f32);
        comparison.insert(
            "memory_saved_bytes".to_string(),
            (*basic_size - *optimized_size) as f32,
        );
        comparison.insert(
            "memory_saved_percent".to_string(),
            ((*basic_size - *optimized_size) as f32 / *basic_size as f32) * 100.0,
        );
    ...
    pub fn analyze_data_set_memory_usage(
        ...
        analysis.insert(
            "memory_saved_percent".to_string(),
            ((basic_total - optimized_total) as f32 / basic_total as f32 * 100.0) as usize,
        );
